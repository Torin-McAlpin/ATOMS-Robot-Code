...
class StraightBackAndForth : OpMode() {
    ...
    override fun init() {
        ...
        forwards = Path(
            BezierLine(
                Point(0.0, 0.0, Point.CARTESIAN), Point(
                    DISTANCE, 0.0, Point.CARTESIAN
                )
            )
        )
        ...
        telemetryA.addLine(
            ("This will run the robot in a straight line going " + DISTANCE
